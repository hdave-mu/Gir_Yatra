        ...
        child: InkWell(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: _pressed
                    ? widget.contact.color.withValues(alpha: 0.4)
                    : Colors.transparent,
                width: 2,
              ),
              boxShadow: [
                BoxShadow(
                  color: _pressed
                      ? widget.contact.color.withValues(alpha: 0.25)
            ...
            child: Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: widget.contact.color.withValues(alpha: 0.12),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(widget.contact.note,
                          style: TextStyle(
                              color: AppTheme.lightBrown.withValues(alpha: 0.75),
                              fontSize: 12,
                              fontWeight: FontWeight.w500)),
                    ],
                  ),
        ...
        child: InkWell(
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: _expanded
                    ? widget.tip.color.withValues(alpha: 0.3)
                    : Colors.transparent,
                width: 2,
              ),
              boxShadow: [
                  ...
                  child: Row(
                    children: [
                      Container(
                        padding: const EdgeInsets.all(11),
                        decoration: BoxDecoration(
                          color: widget.tip.color.withValues(alpha: 0.12),
                          borderRadius: BorderRadius.circular(11),
                        ),
                      ...
                      RotationTransition(
                        ...
                        child: Icon(
                          Icons.expand_more,
                          color: widget.tip.color.withValues(alpha: 0.6),
                          size: 24,
                        ),
                      ),
                    ],
                    ...
                    child: Column(
                      ...
                      children: [
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: widget.tip.color.withValues(alpha: 0.12),
                                    border: Border.all(
                                      color: widget.tip.color.withValues(alpha: 0.3),
                                      width: 1.5,
                                    ),
                                    shape: BoxShape.circle,
                                  ),
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: widget.tip.color.withValues(alpha: 0.08),
                            borderRadius: BorderRadius.circular(10),
                            border: Border.all(
                          ...
                          child: Row(
                            children: [
                              Icon(Icons.phone,
                                  color: widget.tip.color.withValues(alpha: 0.8),
                                  size: 16),
