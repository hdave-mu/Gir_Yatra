              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: isSelected
                        ? m.statusColor
                        : m.statusColor.withValues(alpha: 0.3),
    ...
    return ListView(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [m.statusColor, m.statusColor.withValues(alpha: 0.7)],
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: m.statusColor.withValues(alpha: 0.08),
            borderRadius: BorderRadius.circular(14),
            border: Border.all(color: m.statusColor.withValues(alpha: 0.25)),
          ),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(h,
                              style: TextStyle(
                                  color: m.statusColor.withValues(alpha: 0.85),
                                  fontSize: 13,
  ...
  Widget _infoCard(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppTheme.warmWhite,
        borderRadius: BorderRadius.circular(14),
        border: Border.all(color: AppTheme.primaryBrown.withValues(alpha: 0.1)),
      ),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
                ...
                child: GestureDetector(
                  ...
                  child: Tooltip(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color:
                            m.statusColor.withValues(alpha: m.isOpen ? 0.75 : 0.35),
  ...
  Widget _legendDot(Color color, String label) {
    return Row(
      children: [
        ...
        Text(label,
            style: const TextStyle(fontSize: 11, color: AppTheme.lightBrown)),
      ],
    );
  }
}
