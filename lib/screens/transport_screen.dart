    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _tip('Auto-rickshaws available from Sasan village to Devalia (₹100–150)'),
          _tip('Taxis from Sasan to Somnath: ₹600–800'),
          _tip('Forest dept. jeeps for official safaris — no private vehicles inside'),
          _tip('Hire a local guide at ₹150–300 — worth every rupee for navigation'),
          _tip('Self-drive is fine on paved roads, but use caution near forest buffer'),
        ],
      ),
    );
  }
            ...
            AnimatedCrossFade(
              ...
              secondChild: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Divider(color: o.color.withOpacity(0.2)),
