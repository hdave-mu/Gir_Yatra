          ...
          Expanded(
            child: visible.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (_, i) => _PlaceCard(place: visible[i]),
                  ),
          ),
        ],
      ),
      ...
      child: Transform.scale(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: widget.place.color.withOpacity(0.18),
                blurRadius: 16,
                offset: const Offset(0, 6),
              ),
              BoxShadow(
                color: widget.place.color.withOpacity(0.08),
                blurRadius: 8,
                ...
                Container(
                  ...
                  child: Image.asset(
                    ...
                    errorBuilder: (context, error, stackTrace) {
                      return Container(
                        color: widget.place.color.withOpacity(0.15),
                        child: Center(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [
                        widget.place.color,
                        widget.place.color.withOpacity(0.75)
                      ],
                      begin: Alignment.topLeft,
                      end: Alignment.bottomRight,
                    ),
                              ...
                              children: [
                                ...
                                Flexible(
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      color:
                                          widget.place.color.withOpacity(0.9),
                                      fontSize: 11.5,
                                      fontWeight: FontWeight.w500,
                                    ),
                                  ),
  ...
  Widget _buildTravelTips() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: place.color.withOpacity(0.15)),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
