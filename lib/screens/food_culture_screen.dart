  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        ...localDishes.asMap().entries.map((e) => _DishCard(dish: e.value)
            .animate()
            .fadeIn(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            AppTheme.goldenAmber.withValues(alpha: 0.12),
            AppTheme.goldenAmber.withValues(alpha: 0.04),
          ],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
        ...
        border: Border.all(
          color: AppTheme.goldenAmber.withValues(alpha: 0.25),
          width: 1.2,
        ),
        boxShadow: [
          BoxShadow(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            AppTheme.safariOrange.withValues(alpha: 0.1),
            AppTheme.safariOrange.withValues(alpha: 0.03),
          ],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
        ...
        border: Border.all(
          color: AppTheme.safariOrange.withValues(alpha: 0.2),
          width: 1.2,
        ),
        boxShadow: [
          BoxShadow(
            color: AppTheme.safariOrange.withValues(alpha: 0.14),
            blurRadius: 12,
            offset: const Offset(0, 4),
          ),
        ],
            ...
            Row(
              children: [
                Container(
                  padding: const EdgeInsets.all(10),
                  decoration: BoxDecoration(
                    color: AppTheme.safariOrange.withValues(alpha: 0.15),
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
                      color: AppTheme.safariOrange.withValues(alpha: 0.25),
                      width: 1,
                    ),
                  ),
                  child:
    ...
    return ListView(
      ...
      children: [
        ...
        ...cultureTraditions
            .asMap()
            .entries
            .map((e) => _CultureCard(tradition: e.value)
                .animate()
                .fadeIn(
                  delay: Duration(milliseconds: 60 * e.key),
                  duration: GirDurations.normal,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            AppTheme.primaryBrown.withValues(alpha: 0.08),
            AppTheme.primaryBrown.withValues(alpha: 0.02),
          ],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
