...
const List<TransportOption> transportOptions = [
  TransportOption(
    ...
    tips: 'Book Rajkot–Sasan Gir taxi in advance from airport prepaid booth. Best airport for Gir.',
    icon: Icons.flight,
  ...
  TransportOption(
    ...
    tips: 'Saurashtra Mail & Saurashtra Express are most convenient. Auto/taxi from Veraval station to Sasan Gir: ₹300–₹500.',
    icon: Icons.train,
  ...
  TransportOption(
    ...
    fare: '₹80 – ₹400',
    tips: 'Junagadh → Talala → Sasan Gir is the most direct route. Private Volvo buses also available from Rajkot.',
  ...
  TransportOption(
    ...
    tips: 'NH 27 via Rajkot is well-maintained. Fuel up at Talala (last major town). Drive slowly through Gir buffer zone — wildlife crossing.',
...
const List<NearbyStation> nearbyStations = [
  NearbyStation(name: 'Veraval', type: 'Railway Station', distance: '40 km', code: 'VRL', icon: Icons.train),
  NearbyStation(name: 'Junagadh', type: 'Railway Station', distance: '65 km', code: 'JND', icon: Icons.train),
  NearbyStation(name: 'Keshod', type: 'Airport', distance: '55 km', code: 'IXK', icon: Icons.flight),
  NearbyStation(name: 'Rajkot', type: 'Airport', distance: '160 km', code: 'RAJ', icon: Icons.flight),
  NearbyStation(name: 'Talala Gir', type: 'Bus Stand', distance: '12 km', code: '—', icon: Icons.directions_bus),
  NearbyStation(name: 'Sasan Gir', type: 'Bus Stop', distance: '0 km', code: '—', icon: Icons.directions_bus),
];
...
const List<ChecklistCategory> checklistCategories = [
  ChecklistCategory(
    ...
    color: Color(0xFF2E7D32),
    items: [
      ChecklistItem(item: 'Safari booking confirmation', isEssential: true, note: 'Digital or printed copy'),
      ChecklistItem(item: 'Valid photo ID (Aadhaar / Passport)', isEssential: true),
      ChecklistItem(item: 'Binoculars', isEssential: false, note: 'Greatly enhances wildlife viewing'),
  ...
  ChecklistCategory(
    ...
    color: Color(0xFF5D4037),
    items: [
      ChecklistItem(item: 'Earth-toned clothes (green, brown, khaki)', isEssential: true, note: 'Avoid bright colours in forest'),
      ChecklistItem(item: 'Light jacket for morning safari', isEssential: true, note: 'Forest is cool at 6 AM'),
      ChecklistItem(item: 'Full-sleeve shirts (sun + insect protection)', isEssential: true),
      ChecklistItem(item: 'Comfortable walking shoes / hiking boots', isEssential: true),
      ChecklistItem(item: 'Wide-brim hat or cap', isEssential: false),
      ChecklistItem(item: 'Sunglasses', isEssential: false),
      ChecklistItem(item: 'Rain poncho (monsoon or unpredictable weather)', isEssential: false),
      ChecklistItem(item: 'Modest clothing for temple visits', isEssential: false, note: 'Required at Somnath & Girnar'),
    ],
  ),
  ChecklistCategory(
    ...
    items: [
      ...
      ChecklistItem(item: 'Insect repellent (DEET-based)', isEssential: true, note: 'Mosquitoes active at dawn/dusk'),
  ...
  ChecklistCategory(
    ...
    items: [
      ...
      ChecklistItem(item: 'Cash in Indian Rupees', isEssential: true, note: 'Many dhabas don\'t accept cards'),
      ChecklistItem(item: 'UPI app / digital payments setup', isEssential: false),
      ChecklistItem(item: 'Travel insurance document', isEssential: false),
      ChecklistItem(item: 'Emergency contact list (printed)', isEssential: true),
  ...
  ChecklistCategory(
    ...
    color: Color(0xFF0277BD),
    items: [
      ChecklistItem(item: 'Reusable water bottle (1 litre+)', isEssential: true, note: 'Eco-friendly, no plastic in forest'),
      ChecklistItem(item: 'Water purification tablets', isEssential: false),
      ChecklistItem(item: 'Energy bars / trail mix', isEssential: false, note: 'For long safari drives'),
  ...
  ChecklistCategory(
    ...
    items: [
      ...
      ChecklistItem(item: 'Power bank (20,000 mAh)', isEssential: true, note: 'No charging inside forest'),
      ...
      ChecklistItem(item: 'Reusable carry bags (no plastic)', isEssential: true, note: 'Mandatory eco-rule'),
...
const List<MonthInfo> seasonalCalendar = [
  MonthInfo(
    ...
    highlights: ['Best photography light', 'High lion sighting probability', 'Birds migrating in'],
  ...
  MonthInfo(
    ...
    highlights: ['Ideal weather', 'Migratory birds present', 'Clear forest views'],
    statusColor: Color(0xFF2E7D32),
    isOpen: true,
  ),
  MonthInfo(
    ...
    highlights: ['Animals near waterholes', 'Fewer tourists', 'Good value deals'],
  ...
  MonthInfo(
    ...
    highlights: ['Best deals on hotels', 'Concentrated at waterholes', 'Fewer queues'],
  ...
  MonthInfo(
    ...
    highlights: ['Kesar mango season 🥭', 'Animals very predictable', 'Cheapest hotel rates'],
  ...
  MonthInfo(
    ...
    highlights: ['Last safaris before closure', 'Very low tourist numbers', 'Mangoes in full season'],
  ...
  MonthInfo(
    ...
    highlights: ['Forest is CLOSED', 'Plan alternate Gujarat destinations', 'Somnath beach visits possible'],
  ...
  MonthInfo(
    ...
    highlights: ['Forest is CLOSED', 'Girnar is green & beautiful', 'Somnath is accessible'],
    statusColor: Color(0xFFD32F2F),
    isOpen: false,
  ),
  MonthInfo(
    ...
    highlights: ['Forest is CLOSED', 'Girnar trekking season opens', 'Navratri festivities'],
    statusColor: Color(0xFFD32F2F),
    isOpen: false,
  ),
  MonthInfo(
    ...
    highlights: ['Forest reopens!', 'Green & fresh landscape', 'Navratri cultural experience'],
    statusColor: Color(0xFF2E7D32),
    isOpen: true,
  ),
  MonthInfo(
    ...
    highlights: ['BEST month to visit', 'Maximum lion activity', 'Perfect weather', 'Diwali celebrations'],
  ...
  MonthInfo(
    ...
    highlights: ['Peak tourist season', 'Book 3 weeks ahead', 'Excellent birdwatching', 'Christmas wildlife camps'],
    statusColor: Color(0xFF1B5E20),
    isOpen: true,
  ),
];
...
const List<WildlifeFact> wildlifeFacts = [
  WildlifeFact(
    animal: 'Asiatic Lion',
    fact: 'Unlike African lions, Asiatic lions live in small family groups called prides. Males here often live separately from females except during mating.',
    emoji: '🦁',
    color: Color(0xFFFF8F00),
  ),
  WildlifeFact(
    animal: 'Indian Leopard',
    fact: 'Leopards in Gir are highly adaptable and often found in the buffer zones. They are mostly nocturnal and expert tree climbers.',
    emoji: '🐆',
    color: Color(0xFF5D4037),
  ),
  WildlifeFact(
    animal: 'Mugger Crocodile',
    fact: 'The Hiran River in Gir has one of India\'s highest densities of mugger crocodiles. They regulate their body temperature by basking on banks.',
    emoji: '🐊',
    color: Color(0xFF2E7D32),
  ),
  WildlifeFact(
    animal: 'Indian Porcupine',
    fact: 'One of the most common but rarely seen animals in Gir. Porcupines are nocturnal and their quills can be up to 35 cm long.',
    emoji: '🦔',
    color: Color(0xFF795548),
  ),
  WildlifeFact(
    animal: 'Bonnet Macaque',
    fact: 'The bonnet macaque troops in Gir are well-studied. They have a unique "bonnet" of hair on their heads and live in large social groups.',
    emoji: '🐒',
    color: Color(0xFF6A1B9A),
  ),
  WildlifeFact(
    animal: 'Indian Eagle-Owl',
    fact: 'Gir is home to over 300 bird species. The Indian eagle-owl is the largest owl in India, with a wingspan of up to 1.5 metres.',
    emoji: '🦅',
    color: Color(0xFF0277BD),
  ),
];
